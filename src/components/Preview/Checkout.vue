    ...
    <main>
        <section class="section checkout">
            <div class="section-header">
                <h2 class="headline--xl">Checkout</h2>
            </div>

            <!-- INVOICE ADDRESS -->
            <div class="step-container">
                <div class="step step--invoice">
            ...
            <!-- PAYMENT METHOD -->
            <div class="step-container">
                <div class="step step--payment step--state--default">
                    <div class="step__title">
                        <h3 class="headline--lg">
                            Payment method
                        </h3>
            ...
            <div class="footer">
                <h2 class="headline--xl">Zusammenfassung</h2>
                ...
                <button
                    class="supr-btn supr-btn--primary supr-btn--block supr-btn--lg"
                >
                    Jetzt bezahlen
                </button>
                <div class="text-center">
                    <small>powered by wirestep</small>
                </div>
            </div>
        </section>
    </main>
